    ...
    try:
        ...
        system_prompt = {
            ...
            "content": (
                ...
                "5. Якщо клієнт хоче замовлення, ти ПОВИНЕН послідовно зібрати: 1) Товар, колір, розмір. 2) Номер телефону. 3) Адресу доставки.\n"
                "6. ЗАБОРОНЕНО писати 'ЗАМОВЛЕННЯ ПРИЙНЯТО', поки у тебе немає ОДНОЧАСНО: товару, телефону ТА адреси. Якщо чогось не вистачає — прямо запитай про це.\n" 
                "7. ОФОРМЛЕННЯ: Коли є всі дані (товар, розмір, телефон, адреса) — напиши 'ЗАМОВЛЕННЯ ПРИЙНЯТО' та подякуй.\n"
